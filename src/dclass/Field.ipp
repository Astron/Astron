...
//     This is set for fields that are generated by the parser as placeholder
//     for missing fields, as when reading a partial file;
//     it should not occur in a normal valid dc file.
inline bool Field::is_bogus_field() const
{
	return m_bogus_field;
}
...
inline void Field::set_number(int number)
{
	m_number = number;
}
...
//     only by the Class interface as the field is added.
inline void Field::set_class(Class *dclass)
{
	m_class = dclass;
}
