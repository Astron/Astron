...
bool unpack_db_fields(DatagramIterator &dg, dclass::Class* dclass,
                      std::unordered_map<dclass::Field*, std::vector<uint8_t> > &required,
                      std::map<dclass::Field*, std::vector<uint8_t> > &ram);
